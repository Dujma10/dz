...
int main()
{
    ...
    int brUcenika = 0;
    fstream datoteka("C:/Users/Ga-gama/Documents/dz/data.bin", ios::binary | ios::in);
    ...
    fstream datoteka1("C:/Users/Ga-gama/Documents/dz/data.bin", ios::binary | ios::out | ios::trunc);
